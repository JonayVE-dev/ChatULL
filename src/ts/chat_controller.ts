...
class ChatController {
  ...
  public Init() {
    ...
    this.subject_controller_
      ...
      let message = new Message("Hola, soy ChatULL, tu asistente virtual.<br>Para comenzar, selecciona una asignatura de las mostradas en el menú de la izquierda, si no te aparece la asignatura que buscas, puedes darle al botón de crear nuevo chat y buscarla.<br><br>¡Importante!: Como asistente no guardo contexto de preguntas anteriores así que para asegurar que las respuestas sean lo más precisas posibles realiza preguntas individuales. Evite realizar preguntas sobre varios apartados de las Guías Docentes o la reglamentación.", false);
